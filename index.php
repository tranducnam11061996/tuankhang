...
if (is_array($img)) {
    ...
    $anhslidertrangchu = '<img src="'.esc_url($img).'" alt="Công ty TNHH Dược và Thiết bị y tế Tuấn Khang" width="1360" height="475">';
                                ...
                                ?>
                                <li>
                                    <a href="#" title="<?php esc_html_e("Công ty TNHH Dược và Thiết bị y tế Tuấn Khang", "tuankhang"); ?>"
                                ...
                                <div class="info">
                                    ...
                                    <div class="readmore" style="padding-top: 25px;padding-bottom: 10px;">
                                        <a href="<?php echo esc_url($story_link); ?>" class="btn-readmore">
                                            <?php esc_html_e("Xem thêm", "tuankhang"); ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="dtv-list">
                        ...
                        for ($infodem = 1; $infodem <= 3; $infodem++) {
                            ...
                            if (!empty($info_title) || empty($info_des)) {
                                echo '<div class="dtv-list-item"><div class="inner"><h3>' . esc_html($info_title) . '</h3><p>' . ent2ncr($info_des) . '</p></div></div>';
                            }
                        }
                        ?>
                    </div>
                                ...
                                <div class="grid-item item-<?php echo esc_attr($tindem); ?>">
                                    <div class="inner">
                                        ...
                                        if ( isset($tintuc_link) && !empty($tintuc_link) ) {
                                            echo '<div class="view-more"><a href="'.esc_url($tintuc_link).'">'.esc_html__("Xem thêm", "tuankhang").'</a></div>';
                                        }
                                        ?>
                                    </div>
                                </div>
            ...
            <section class="h-tin-tuc h-system">
                <div class="uk-container uk-container-center">
                    <?php
                    $system_name = get_field('duytv_system_name', $post_ID);
                    $system_link_all = get_field('duytv_system_link_all', $post_ID);

                    if(!empty($system_name)) echo '<div class="h-panel-head"><h3 class="heading-2">'.esc_html($system_name).'</h3></div>';
                    ?>
                    <div class="tin-tuc-list grid">
                        <?php
                        for ($systemdem = 1; $systemdem <= 5; $systemdem++) {
                            $system_image = get_field('duytv_system_image_' . $systemdem, $post_ID);
                            $system_title = get_field('duytv_system_title_' . $systemdem, $post_ID);
                            $system_link = get_field('duytv_system_link_' . $systemdem, $post_ID);

                            if( !empty($system_title) || !empty($system_image)){
                                ?>
                                <div class="grid-item item-<?php echo esc_attr($systemdem); ?>">
                                    <div class="inner">
                                        <?php
                                        if ( isset($system_image) && !empty($system_image) ) {
                                            echo '<div class="image"><img src="' . esc_url($system_image["url"]) . '" width="' . esc_attr($system_image["width"]) . '" height="' . esc_attr($system_image["height"]) . '" alt="" /></div>';
                                        }

                                        if ( isset($system_title) && !empty($system_title) ) {
                                            echo '<h3>';
                                            if ( isset($system_title) && !empty($system_title) ) echo '<a href="'.esc_url($system_link).'">';
                                            echo esc_html($system_title);
                                            if ( isset($system_title) && !empty($system_title) ) echo '</a>';
                                            echo '</h3>';
                                        }

                                        if ( isset($system_link) && !empty($system_link) ) {
                                            echo '<div class="view-more"><a href="'.esc_url($system_link).'">'.esc_html__("Xem thêm", "tuankhang").'</a></div>';
                                        }
                                        ?>
                                    </div>
                                </div>
                    ...
                    <?php
                    if(isset($system_link_all) && !empty($system_link_all)){
                        echo '<div class="text-center"><a title="'.esc_html__("Sản phẩm", "tuankhang").'" class="btn-all text-uppercase" href="'.esc_url($system_link_all).'">'.esc_html__("Xem toàn bộ", "tuankhang").'</a></div>';
                    }
                    ?>
                </div><!-- panel-body -->
            </section><!-- h-system -->

            <section class="h-tin-tuc h-product">
                <div class="uk-container uk-container-center">
                    <div class="h-panel-head">
                        <h3 class="heading-2"><a href="https://tuankhangmedical.com/san-pham" title="Sản phẩm">Sản phẩm nổi bật</a></h3>
                        <p></p>
                    </div>
                    <div class="tin-tuc-list grid">
                        <?php
...
?>
                                <div class="grid-item item-<?php echo esc_attr($sanphamdem); ?>">
                                    <div class="inner">
                                        <?php if(isset($anhsanphamtrangchu) && !empty($anhsanphamtrangchu)){ ?>
                                            <div class="image">
                                                <a href="<?php echo $linklienketsanpham; ?>"><?php echo $anhsanphamtrangchu; ?></a>
                                            </div>
                                        <?php } ?>
                                        <?php if(isset($tensanphamtrangchu) && !empty($tensanphamtrangchu)){ ?>
                                            <h3><a title="<?php echo $tensanphamtrangchu; ?>"
                                                   href="<?php echo $linklienketsanpham; ?>"><?php echo $tensanphamtrangchu; ?></a>
                                            </h3>
                                        <?php } ?>
                                        <?php if(isset($linklienketsanpham) && !empty($linklienketsanpham)){ ?>
                                            <div class="view-more">
                                                <a title="<?php echo $tensanphamtrangchu; ?>"
                                                   href="<?php echo $linklienketsanpham; ?>"><?php esc_html_e("Xem thêm", "tuankhang"); ?></a>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
                    ...
                    <div class="text-center">
                        <a title="Sản phẩm" class="btn-all text-uppercase"
                           href="https://tuankhangmedical.com/san-pham"><?php esc_html_e("Xem toàn bộ sản phẩm", "tuankhang"); ?></a>
                    </div>
                </div><!-- panel-body -->
            </section><!-- h-product -->
            ...
            <section class="h-news h-project">
                <div class="uk-container uk-container-center">
                    <div class="h-panel-head">
                        <h3 class="heading-2"><?php esc_html_e("Dự án tiêu biểu", "tuankhang"); ?></h3>
                        <p></p>
                    </div>
...
?>
            ...
            <section class="h-news home-box-office">
                <div class="uk-container uk-container-center">
                    <div class="h-panel-head">
                        <h3 class="heading-2"><?php esc_html_e("Hành trình thực hiện ước mơ", "tuankhang"); ?></h3>
                    </div>
                    ...
                    <div class="home-office-list">
                        <div class="home-office-item">
                            <p>
                                <span class="counter" data-count="100000">10000</span>+
                            </p>
                            <p><?php esc_html_e("Khách Hàng", "tuankhang"); ?></p>
                        </div>
                        <div class="home-office-item">
                            <p>
                                <span class="counter" data-count="30">30</span>+
                            </p>
                            <p><?php esc_html_e("HÃNG SẢN XUẤT", "tuankhang"); ?></p>
                        </div>
                        <div class="home-office-item">
                            <p>
                                <span class="counter" data-count="35">35</span>+
                            </p>
                            <p><?php esc_html_e("CONTAINER MỖI NĂM", "tuankhang"); ?></p>
                        </div>
                        <div class="home-office-item">
                            <p>
                            ...
                            <p><?php esc_html_e("Hỗ trợ", "tuankhang"); ?></p>
                        </div>
                        <div class="home-office-item">
                            <p>
                                <span class="counter" data-count="12">12</span>+
                            </p>
                            <p><?php esc_html_e("Năm Kinh nghiệm", "tuankhang"); ?></p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="h-partner">
                <div class="partner">
                    <div class="uk-container uk-container-center">
                        <div class="h-panel-head">
                            <h3 class="heading-2"><?php esc_html_e("Đối tác của TUẤN KHANG", "tuankhang"); ?></h3>
                        </div>
                                                ...
                                                <li>
                                                    <div class="thumb">
                                                        <a class="image img-scaledown" href="#"
                                                           title="<?php esc_html_e("Đối tác của Tuấn Khang", "tuankhang"); ?>"><?php echo $anhdoitactrangchu; ?></a>
                                                    </div>
                                                </li>
                                                <?php
                                            }
