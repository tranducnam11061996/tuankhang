    ...
    <div class="tk-container py-14 md:py-16">
        <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-12 lg:gap-8">
            <section class="lg:col-span-4">
                ...
                <a class="inline-flex" href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo esc_attr($transparent_pixel); ?>" data-deferred-src="<?php echo esc_url(tk_site_logo(true)); ?>" width="200" height="139" class="h-auto w-[172px]" decoding="async" alt="<?php echo esc_attr($company_name); ?>"><noscript><img src="<?php echo esc_url(tk_site_logo(true)); ?>" width="200" height="139" class="h-auto w-[172px]" alt="<?php echo esc_attr($company_name); ?>"></noscript></a>
